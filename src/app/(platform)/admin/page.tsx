...
export default async function AdminPage() {
  ...
  return <>
    ...
    <div className="admin-warning"><CircleAlert size={19} /><div><strong>Separation of duties remains enforced</strong><p>Business owners cannot create organizations, campaign activation cannot bypass credit holds, and every privileged data change is recorded.</p></div></div>
  </>;
}
