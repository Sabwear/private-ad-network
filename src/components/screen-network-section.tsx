...
export function ScreenNetworkSection({ result, canManageDevices }: { result: ScreensResult; canManageDevices: boolean }) {
  ...
  return <section id="screens" className="workspace-section-anchor business-network-section">
    <div className="section-heading"><div><p className="eyebrow">Device network</p><h2>Screens</h2><p>Pair approved playback devices, monitor health, and inspect each screen in the same business workspace.</p></div><span className="management-count"><MonitorUp size={16} /> {result.summary.registered} screens</span></div>
