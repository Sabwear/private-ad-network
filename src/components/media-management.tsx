...
import { CheckCircle2, FileVideo, LoaderCircle, ShieldCheck, Upload, XCircle } from "lucide-react";
import { useRouter } from "next/navigation";
import { useActionState, useState } from "react";
import { moderateMedia, prepareMediaUpload, submitMediaUpload, type MediaActionState } from "@/app/(platform)/media/actions";
...
export function MediaUploadPanel() {
  ...
  return (
    <form className="panel media-upload-form" onSubmit={handleSubmit} noValidate>
      <div className="panel-header"><div><p className="eyebrow">Private upload</p><h2>Add a new creative</h2><p>The original file stays private and is available only through short-lived authorized links.</p></div><FileVideo size={22} /></div>
